    ...
    def do_POST(self):
    	...
    	if cType != 'application/json':
	    	...
	    	try:
	    		...
	    		self.wfile.write(b'Please dont use quotes around arguements value')


if __name__ == '__main__':
    httpd = HTTPServer((HOST_NAME, PORT_NUMBER), SimpleHTTPRequestHandler)
    httpd.socket = ssl.wrap_socket(httpd.socket, server_side=True, keyfile= 'private_key', certfile='localhost.pem',ssl_version=ssl.PROTOCOL_TLS)
